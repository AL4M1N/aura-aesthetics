    ...
    <div className="min-h-screen bg-[var(--aura-cream)]">
      ...
      <section className="relative min-h-screen flex items-center overflow-hidden">
        ...
        <div className="absolute bottom-12 left-1/2 -translate-x-1/2">
          ...
          >
            <span className="font-['Inter'] text-xs tracking-widest text-[var(--aura-soft-taupe)] uppercase">Scroll</span>
            <div className="w-px h-16 bg-gradient-to-b from-[var(--aura-rose-gold)] to-transparent" />
          </motion.div>
        </div>
      </section>
